...
public class Graph {
    ...
    public void resetGraph(HashMap newVerts, HashMap newEdges) {
        this.vertices = newVerts;
        this.edges = newEdges;
    }

    public HashMap returnVertices() {
        return this.vertices;
    }

    public HashMap returnEdges() {
        return this.edges;
    }
    ...
    public boolean addEdge(Vertex one, Vertex two, int weight) {
        ...
        //System.out.println("Edge of " + e.getOne() + " and " + e.getTwo() + " added with weight" + e.getWeight());
        one.addNeighbor(e);
        two.addNeighbor(e);
        return true;
    }
    ...
    public boolean containsEdge(Edge e) {
        ...
        return true;
                //this.edges.containsKey(e.hashCode());
    }
...
//        return this.vertices.getOrDefault(this, defaultValue)
//    }
    /**
